  ...
  const data = {
    Games: [
      ...
      },
      {
        ...
        category: "game",
        categoryIndex: 1,
        image: "/projects/spacewords.png",
        description:
          "Space words game where you can type the words to destroy the asteroids",
        madeWith: ["godot"],
        links: {
          website: "https://spaceword.netlify.app",
        },
      },
      {
      ...
      },
      {
        ...
        category: "game",
        categoryIndex: 1,
        image: "/projects/gravityCat.png",
        description:
          "Cat game where you dodge obstacles and collect the coins with a leaderboard",
        madeWith: ["godot"],
        links: {
          website: "https://gregarious-dodol-02bf34.netlify.app",
        },
      },
      {
        title: "2048",
